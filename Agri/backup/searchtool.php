        ...
        <div id="navbar" class="navbar-collapse collapse">
          <form class="navbar-form navbar-center" action="" method="POST">
		   <div class="form-group">
            ...
            <div class="form-group">
             <a class="navbar-brand" href="toollist.php"><font color="#4ffF50"><font color="white">TOOLS</font></a>
            </div>
               <div class="form-group">
             <a class="navbar-brand" href="toolcart.php"><font color="#4ffF50">CARTS</a>
            </div>
...
<font color="black">				
  ...
  <form action="toolconf.php" method="POST">
   <table border="0" width="1080" height="400" style="border-radius:0px;background-color:white;">
		...
		<tr><td colspan="4" >&nbsp &nbsp <center><input type="submit" name="submit" value="ORDER NOW" style="border:2px solid red; color:red; padding:10px 40px; background:none;"></center><br></td></tr>
...
<?php
     if(isset($_REQUEST['search_btn']))
    {
		...
		?>
		<script>
			window.location = "searchtool.php?pass=<?php echo $ggn ?>";
		</script>
		<?php
	}
 ?>
