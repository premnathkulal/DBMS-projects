		   ...
		   <div class="form-group">
            ...
            <div class="form-group">
             <a class="navbar-brand" href="agrotools.php"><font color="#4ffF50"><font color="#4ffF50">MANAGE</font></a>
               ...
               <div class="form-group">
             <a class="navbar-brand" href="advtool.php?pass=agritools"><font color="WHITE">TOOLS</a>
            </div>
			 <div class="form-group">
	...
	<br><br><br><br><br><br><br>
		...
		session_start();
			...
			if($va == 'agritools'){
				 ...
				 $sq="select * from agritools where name like '%$va%'";
			}
 ...
 ?>
  ...
  <?php
     if(isset($_REQUEST['search_btn']))
    {
		...
		?>
		<script>
			window.location = "advtool.php?pass=<?php echo $ggn ?>";
		</script>
		<?php
	}
	if(isset($_POST['submit'])){
		...
		$pdo = new PDO("mysql:host=$host;dbname=$db_name", $user_name,$user_password);
		
		$tid = $_POST['tid'];
		
		$sql = 'CALL remove_tool(:tid)';
