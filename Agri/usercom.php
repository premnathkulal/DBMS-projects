...
#trd:hover #tdd {
 ...
 <div style="position:fixed;left:80px;top:70px; background-color:rgba(0,0,0,0.2);" >
	 ...
	 <div class="container" >  
    <h1><Center><b>USER COMMENTS</center></h1>				 
	</div>
	</div>    
 
	  <CENTER><br><br><br><br><table border="0" width="98%" S>
	  <tr>
			<td  width=100px ><hr id="k1"><center><b>EMAIL</b></center><hr id="k1"></td>
				
			<td  width=100px><hr id="k1"><center><b>MESSAGE</b></center><hr id="k1"></td>
			...
			<td  width=100px><hr id="k1"><center><b>DELETE</b></center><hr id="k1"></td>
		        ...
		        $poc="select * from request as r where  r.Role='USER'";				
...
<form action="" method="POST" >		
          <center>
           <div class="col-md-12">
		            ...
		            <tr  id ="trd">
					     <td id ="tdd" height="20px"><center><input type="submit" name="view" value = "<?php echo "$name"; ?>" style="color:black; width:100%; background-color:rgba(0,0,0,0s); height:100%"/>
						 ...
						 <input type="hidden" name= "id" value="<?php echo "$id"; ?>" readOnly style="color:rgba(0,0,0,0); border:none; background:rgba(0,0,0,0)">
						  ...
						  <td id ="tdd" height="20px"><center><input type="submit" name="view" value = "<?php echo  substr($msg, 0, 90);echo "........"; ?>" style="color:black; width:100%; background-color:rgba(0,0,0,0s); height:100%"/></center><hr id = "k2"></td>	
						  ...
						  <td id ="tdd"><center><input type="image" name = "delete" src="img/logo/del.png" alt="Submit" width="15px" height="14px"/></center></td>
